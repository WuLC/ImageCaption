...
os.environ["CUDA_VISIBLE_DEVICES"] = '2' # use GPU only
...
input_file = '../data/coco/val2014png/COCO_val2014_000000000074.png,../data/coco/val2014png/COCO_val2014_000000000196.png'
